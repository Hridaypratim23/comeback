...
export const WORKOUT_PLANS: Workout[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: 'pallof', name: 'Pallof Press', sets: 3, repsRange: '12', notes: 'Anti-rotation — resist the cable', unilateral: true },
      { id: 'woodchop', name: 'Cable Wood Chop', sets: 3, repsRange: '12', notes: 'Drive from hips, not arms', unilateral: true },
    ],
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: 'sl-rdl', name: 'Single Leg RDL', sets: 3, repsRange: '10', notes: 'Slow eccentric, feel the hamstring load', unilateral: true },
      { id: 'stepup', name: 'Weighted Step-ups', sets: 3, repsRange: '12', notes: 'Drive through the heel, no push-off from back foot', unilateral: true },
      { id: 'hipthrust', name: 'Hip Thrusts', sets: 3, repsRange: '12–15', notes: 'Full glute squeeze at the top, chin tucked' },
      { id: 'boxjump', name: 'Box Jumps', sets: 3, repsRange: '6–8', notes: 'Land softly — absorb with your hips, not just knees', bodyweight: true },
      { id: 'farmer', name: 'Farmer\'s Carry', sets: 3, repsRange: '30', notes: 'Heavy. Shoulders packed, walk with purpose', inputUnit: 'sec' },
    ],
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: 'ab-wheel', name: 'Ab Wheel Rollout', sets: 3, repsRange: '10–12', notes: 'Brace your core the entire rep, don\'t let your hips sag', bodyweight: true },
      { id: 'l-sit', name: 'L-Sit Hold (parallel bars)', sets: 3, repsRange: '20–30', notes: 'Legs straight, depress the shoulders hard', bodyweight: true, inputUnit: 'sec' },
      { id: 'toes-to-bar', name: 'Toes to Bar', sets: 3, repsRange: '10–15', notes: 'Control the swing — don\'t kip wildly', bodyweight: true },
    ],
